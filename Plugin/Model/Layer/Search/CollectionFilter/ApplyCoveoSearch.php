...
namespace Coveo\Search\Plugin\Model\Layer\Search\CollectionFilter;
...
use Coveo\Search\Block\Search\SearchMessageFactory;
...
class ApplyCoveoSearch extends \Magento\CatalogSearch\Model\Layer\Search\Plugin\CollectionFilter
{
    /**
     * @var LoggerInterface
     */
    ...
    public function afterFilter(
        ...
        if ($this->config->isSearchEnabled() !== true) {
            $this->logger->debug('[search plugin] Coveo search is disable, using default Magento search');
