...
use Coveo\Search\Api\Service\SearchInterfaceFactory;
...
class GenerateDummyData extends Command
{
    ...
    {
        $this->setName('coveo:dummy-data')
            ->setDescription('Generate dummy data based on Coveo search response')
            ->setDefinition([
                new InputArgument(
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \Coveo\SDK\Search\Result $result */
        $result = $search->execute($queryText);
        ...
        foreach ($results as $key => $sku) {
            try{
                ...
                $product->setDescription("Product autogenerated searching for '$queryText' on Coveo");
